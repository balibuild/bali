...
type BuildCommand struct {
	...
	Destination    string `name:"dest" short:"D" help:"Specify the package save destination" default:"dest"`
	CompressMethod string `name:"compress-method" help:"Specifies the compression method"`
}
...
func (c *BuildCommand) Run(g *Globals) error {
	b := barrow.BarrowCtx{
		...
		CompressMethod: strings.ToLower(c.CompressMethod),
		Verbose:        g.Verbose,
	}
